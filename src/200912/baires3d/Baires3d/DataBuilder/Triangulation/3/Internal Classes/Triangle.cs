...
namespace b3d
{
    ...
    /// </summary>
    internal struct TTriangle
    {
        public readonly Vertex A;
        public readonly Vertex B;
        public readonly Vertex C;

        public TTriangle(Vertex a, Vertex b, Vertex c)
        {
            A = a;
            B = b;
            C = c;
        ...
        {
            return new TTriangle(a, b, c).ContainsPoint(point);
        }
        ...
        {
            if (obj.GetType() != typeof (TTriangle))
                return false;
            return Equals((TTriangle) obj);
        }

        public bool Equals(TTriangle obj)
        {
