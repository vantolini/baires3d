...
namespace b3d
{
    ...
    /// </summary>
    public static class TriangulationWiki
    {
        /// <summary>
        ...
        public static int[] Triangulate(params Vector2[] vertices)
        {
            ...
            int oldOLDNumOfTris = -1, oldNumOfTris = -1, currentNumOfTris = -1;
            ...
            do
            {
                ...
                for (int i = 0; i < points.Count; i++)
                {
                    ...
                    if (crossProductZ < 0) reflexPoints.Add(i); // replaces "if (angle > MathHelper.PiOver2)"
                }
