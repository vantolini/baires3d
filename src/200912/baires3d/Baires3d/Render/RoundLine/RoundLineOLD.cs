...
namespace b3d
{
    ...
    public class RoundLineManager
    {
        ...
        private EffectParameter worldMatrixParameter;
        ...
        public void Init(GraphicsDevice device, ContentManager content)
        {
            ...
            worldMatrixParameter = effect.Parameters["worldMatrix"];
        ...
        private void CreateRoundLineMesh()
        {
            ...
            for (int instance = 0; instance < numInstances; instance++)
            {
                ...
                iVertex = iv;
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, -1.0f, 0), new Vector2(1, threePi2), new Vector2(0, 0),
                                                instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, -1.0f, 0), new Vector2(1, threePi2), new Vector2(0, 1),
                                                instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 0.0f, 0), new Vector2(0, threePi2), new Vector2(0, 1),
                                                instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 0.0f, 0), new Vector2(0, threePi2), new Vector2(0, 0),
                                                instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 0.0f, 0), new Vector2(0, pi2), new Vector2(0, 1),
                                                instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 0.0f, 0), new Vector2(0, pi2), new Vector2(0, 0),
                                                instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 1.0f, 0), new Vector2(1, pi2), new Vector2(0, 1),
                                                instance);
                tri[iv++] = new RoundLineVertex(new Vector3(0.0f, 1.0f, 0), new Vector2(1, pi2), new Vector2(0, 0),
                                                instance);
                ...
                for (int i = 0; i < primsPerCap + 1; i++)
                {
                    ...
                    tri[iVertex + 0] = new RoundLineVertex(new Vector3(0, 0, 0), new Vector2(0, theta1),
                                                           new Vector2(0, 0), instance);

                    // odd-numbered indices are at the perimeter of the halfdisc
                    float x = (float) Math.Cos(theta0);
                    float y = (float) Math.Sin(theta0);
                    tri[iVertex + 1] = new RoundLineVertex(new Vector3(x, y, 0), new Vector2(1, theta0),
                                                           new Vector2(1, 0), instance);
                ...
                for (int i = 0; i < primsPerCap + 1; i++)
                {
                    ...
                    // even-numbered indices are at the center of the halfdisc
                    tri[iVertex + 0] = new RoundLineVertex(new Vector3(0, 0, 0), new Vector2(0, theta1),
                                                           new Vector2(0, 1), instance);

                    // odd-numbered indices are at the perimeter of the halfdisc
                    float x = (float) Math.Cos(theta0);
                    float y = (float) Math.Sin(theta0);
                    tri[iVertex + 1] = new RoundLineVertex(new Vector3(x, y, 0), new Vector2(1, theta0),
                                                           new Vector2(1, 1), instance);
                         ...
                         float time, string techniqueName)
        {
            ...
            device.DrawIndexedPrimitives(PrimitiveType.TriangleList, 0, 0, numVertices, 0,
                                         numPrimitivesPerInstance*numInstancesThisDraw);
        ...
        /// </summary>
        public void Draw(ref List<RoundLine> roundLines, float lineRadius, Color lineColor, Matrix viewProjMatrix,
                         float time, string techniqueName)
        {
            device.VertexDeclaration = vdecl;
            device.Vertices[0].SetSource(vb, 0, bytesPerVertex);
            ...
            foreach (RoundLine roundLine in roundLines)
            {
                ...
                //GC.Collect();
                //Constants.Logger.AddLog("theta: " +roundLine.Theta);
                Matrix m = new Matrix(
       (float)Math.Cos(roundLine.Theta),
       0,
        (float)Math.Sin(roundLine.Theta),
        1,
        ...
        roundLine.P0.X,1, roundLine.P0.Y, 1
...
Matrix.CreateScale(1.114f, 1.114f, 1.114f)
//* Matrix.CreateRotation(-(float)Math.Sin(roundLine.Theta)) //(float)Math.Sin(roundLine.Theta)
...
* Matrix.CreateTranslation(roundLine.P0.X, 0, roundLine.P0.Y);*/
                //m.M41 = roundLine.P0.X;
                //m.M42 = roundLine.P0.Y;
                 worldMatrixParameter.SetValue(m);
