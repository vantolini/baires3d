...
namespace b3d
{
    public partial class RoundLine
    {
        ...
        /// </summary>
        public void FindNearbyLines(List<RoundLine> lineList, List<RoundLine> nearbyLineList, float globalLineRadius,
                                    Vector2 referencePos, float referenceRadius)
        {
        ...
        /// </summary>
        public static void FindNearbyLinesWithClipping(List<RoundLine> lineList, List<RoundLine> nearbyLineList,
                                                       float globalLineRadius, Vector2 referencePos,
        ...
        /// </summary>
        public float MinDistanceSquaredDeviation(List<RoundLine> lineList, Vector2 currentPos, float lineRadius,
                                                 float discRadius)
        {
        ...
        /// </summary>
        public void CollideAndSlide(List<RoundLine> lineList, Vector2 currentPos, Vector2 proposedPos, float lineRadius,
                                    float discRadius, out Vector2 finalPos)
        {
            ...
            while (Vector2.DistanceSquared(oldPos, oldTarget) > 0.001f*0.001f)
            {
                ...
                else
                {
                    ...
                    if (doSlide)
                    {
                        ...
                        Vector2 newPoint = new Vector2(newPos.X + (float) Math.Cos(theta),
                                                       newPos.Y + (float) Math.Sin(theta));
