...
public static class FBXMeshGetter
    {
                                       ...
                                       long parentModelId = 0)
    {
        ...
        */
        ...
        Vector3 position = Vector3.Zero;  //gameObj.transform.localPosition;
        ...
        Vector3 localRotation = Vector3.Zero;  //gameObj.transform.localEulerAngles;
        ...
        Vector3 localScale = Vector3.One;  //gameObj.transform.localScale;
...
*/
            ...
            if (meshRenderer != null)
            {
                ...
                for (int i = 0; i < allMaterialsInThisMesh.Length; i++)
                {
                    ...
                    int referenceId = Math.Abs(mat.GetHashCode());
        ...
        for (int i = 0; i < gameObj.transform.childCount; i++)
        {
            ...
            FBXMeshGetter.GetMeshToString(childObject, materials, ref tempObjectSb, ref tempConnectionsSb, gameObj, modelId);
        }
