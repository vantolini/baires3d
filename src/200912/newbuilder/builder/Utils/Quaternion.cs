...
namespace Builder{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        private static Quaternion LookRotation(ref Vector3 forward, ref Vector3 up)
        {
            ...
            forward = Vector3.Normalize2(forward);
            Vector3 right = Vector3.Normalize2(Vector3.Cross2(up, forward));
        ...
        */
        ...
        /* public static implicit operator UnityEngine.Quaternion(Quaternion me)
         ...
         {
             return new Quaternion((float)other.x, (float)other.y, (float)other.z, (float)other.w);
         }
         */
        #endregion
    }
